...
public class RuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addConditionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Rule_conditions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Rule_conditions_feature", "_UI_Rule_type"),
						SmartHomePackage.Literals.RULE__CONDITIONS, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SmartHomePackage.Literals.RULE__EVENT, SmartHomeFactory.eINSTANCE.createEvent()));
