		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmartHomePackage.Literals.BOOLEAN_CONDITION__SENSOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOperandPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanCondition_operand_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanCondition_operand_feature", "_UI_BooleanCondition_type"),
				 SmartHomePackage.Literals.BOOLEAN_CONDITION__OPERAND,
				 true,
				 false,
				 false,
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanCondition_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanCondition_operator_feature", "_UI_BooleanCondition_type"),
				 SmartHomePackage.Literals.BOOLEAN_CONDITION__OPERATOR,
				 true,
				 false,
				 false,
