...
/**
 * This is the item provider adapter for a {@link smartHome.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmartHomePackage.Literals.LOCATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmartHomePackage.Literals.LOCATION__SENSORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartHomePackage.Literals.LOCATION__SENSORS,
				 SmartHomeFactory.eINSTANCE.createIntegerSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SmartHomePackage.Literals.LOCATION__SENSORS,
				 SmartHomeFactory.eINSTANCE.createBooleanSensor()));
	}
