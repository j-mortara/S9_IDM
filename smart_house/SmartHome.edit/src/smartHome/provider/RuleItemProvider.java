...
public class RuleItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmartHomePackage.Literals.RULE__CONDITIONS);
			childrenFeatures.add(SmartHomePackage.Literals.RULE__EVENT);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartHomePackage.Literals.RULE__CONDITIONS,
				 SmartHomeFactory.eINSTANCE.createBooleanCondition()));

		newChildDescriptors.add
			(createChildParameter
				(SmartHomePackage.Literals.RULE__CONDITIONS,
				 SmartHomeFactory.eINSTANCE.createIntegerCondition()));

		newChildDescriptors.add
			(createChildParameter
				(SmartHomePackage.Literals.RULE__EVENT,
				 SmartHomeFactory.eINSTANCE.createEvent()));

		newChildDescriptors.add
			(createChildParameter
				(SmartHomePackage.Literals.RULE__DURATION,
