		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_sensorType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_sensorType_feature", "_UI_Sensor_type"),
				 SmartHomePackage.Literals.SENSOR__SENSOR_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDataFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_dataFile_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_dataFile_feature", "_UI_Sensor_type"),
				 SmartHomePackage.Literals.SENSOR__DATA_FILE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmartHomePackage.Literals.SENSOR__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
