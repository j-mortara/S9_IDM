...
public class LocationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Location_name_feature",
								"_UI_Location_type"),
						SmartHomePackage.Literals.LOCATION__NAME, true, false, false,
	...
	protected void addSensorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_sensors_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_sensors_feature",
								"_UI_Location_type"),
						SmartHomePackage.Literals.LOCATION__SENSORS, true, false, true, null, null, null));
	}
