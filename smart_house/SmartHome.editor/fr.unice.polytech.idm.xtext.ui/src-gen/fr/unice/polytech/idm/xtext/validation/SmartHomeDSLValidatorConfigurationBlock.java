 ...
 */
package fr.unice.polytech.idm.xtext.validation;
...
public class SmartHomeDSLValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(SmartHomeDSLConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("SmartHomeDSL");
		if (section == null) {
			return dialogSettings.addNewSection("SmartHomeDSL");
		}
		return section;
	}
}
