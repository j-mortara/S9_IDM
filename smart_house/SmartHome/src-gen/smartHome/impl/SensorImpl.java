...
public class SensorImpl extends MinimalEObjectImpl.Container implements Sensor {
		...
		if (sensorType != null && sensorType.eIsProxy()) {
			...
			if (sensorType != oldSensorType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmartHomePackage.SENSOR__SENSOR_TYPE,
	...
	public void setSensorType(SensorType newSensorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.SENSOR__SENSOR_TYPE, oldSensorType,
					sensorType));
	}
	...
	public void setDataFile(String newDataFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.SENSOR__DATA_FILE, oldDataFile,
					dataFile));
	}
