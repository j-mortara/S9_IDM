...
public class SmartHomeImpl extends MinimalEObjectImpl.Container implements SmartHome {
	...
	public EList<Location> getLocations() {
		if (locations == null) {
			locations = new EObjectContainmentEList<Location>(Location.class, this,
					SmartHomePackage.SMART_HOME__LOCATIONS);
		}
		return locations;
	}
	...
	public EList<SensorType> getSensorTypes() {
		if (sensorTypes == null) {
			sensorTypes = new EObjectContainmentEList<SensorType>(SensorType.class, this,
					SmartHomePackage.SMART_HOME__SENSOR_TYPES);
		}
		return sensorTypes;
	}
