...
public class BooleanConditionImpl extends ConditionImpl implements BooleanCondition {
		...
		if (sensor != null && sensor.eIsProxy()) {
			...
			if (sensor != oldSensor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmartHomePackage.BOOLEAN_CONDITION__SENSOR, oldSensor, sensor));
			}
		}
		return sensor;
	}
	...
	public void setSensor(BooleanSensor newSensor) {
		...
		sensor = newSensor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.BOOLEAN_CONDITION__SENSOR, oldSensor, sensor));
	}
	...
	public void setOperand(boolean newOperand) {
		...
		operand = newOperand;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.BOOLEAN_CONDITION__OPERAND, oldOperand, operand));
	}
	...
	public void setOperator(BooleanOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.BOOLEAN_CONDITION__OPERATOR, oldOperator, operator));
	}
