...
public class IntegerConditionImpl extends ConditionImpl implements IntegerCondition {
		...
		if (sensor != null && sensor.eIsProxy()) {
			...
			if (sensor != oldSensor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmartHomePackage.INTEGER_CONDITION__SENSOR, oldSensor, sensor));
			}
		}
		return sensor;
	}
	...
	public void setSensor(IntegerSensor newSensor) {
		...
		sensor = newSensor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.INTEGER_CONDITION__SENSOR, oldSensor, sensor));
	}
	...
	public void setOperand(int newOperand) {
		...
		operand = newOperand;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.INTEGER_CONDITION__OPERAND, oldOperand, operand));
	}
	...
	public void setOperator(IntegerOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.INTEGER_CONDITION__OPERATOR, oldOperator, operator));
	}
